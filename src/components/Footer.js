...
export default function Footer() {
  return (
    <footer className="bg-third-blue px-24 pt-12 pb-16 flex flex-col">
      <div className="flex flex-row justify-between">
        ...
        <div className="w-2/5 flex flex-col gap-8">
          ...
          <form className="flex flex-col gap-4">
            ...
            />
            <textarea className="text-white bg-transparent">
              Your comment
            </textarea>
            <button className="bg-white text-primary-blue rounded-full py-2 font-semibold">
              Submit
            </button>
          </form>
        </div>
